...
![This passing plane is clearly visible on the spectrogram when zoomed out.](media/image10.png){width="6.5in"}
...
could last as much as a minute. Press **Ctrl+0** to completely zoom out,
fitting the whole spectrogram into view (it may take a second for your
...
::: {.callout-note}
If there's an occasional event that repeats across the whole file —
e.g. a cricket chirping once every three seconds — you will,
...
Otherwise, the space between the events may end up in the training
data labeled with the event.
:::

You must update the annotations as you listen to the track. If you
pre-labeled a passing plane, you may find that it's still audible longer
