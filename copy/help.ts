...
export const help = {
  ...
  bulk: {
    ...
    get p_rename2() { return getOverride('help.bulk.p_rename2') ?? "Open **Rename matches** at the foot of the panel, type a replacement label, and click **Rename All** to rename every annotation the search currently matches — current track only, the entered folder, or the whole project, per the scope chosen above. A confirmation shows how many annotations were renamed and across how many recordings."; },
  },
