...
export const tooltips = {
  ...
  get syncUnpushed() { return getOverride('tooltips.syncUnpushed') ?? "Your annotations aren't uploaded yet"; },
  get syncUnpulled() { return getOverride('tooltips.syncUnpulled') ?? "Teammates have new annotations"; },
  ...
  get showAllFiles() { return getOverride('tooltips.showAllFiles') ?? "Show all files"; },
  ...
  get switchToSorted() { return getOverride('tooltips.switchToSorted') ?? "Switch to sorted view"; },
  get shuffleQueue() { return getOverride('tooltips.shuffleQueue') ?? "Shuffle queue"; },
};
