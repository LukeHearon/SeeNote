    ...
    pages: [
      ...
      },
      {
        ...
        blocks: () => [
          ...
          { kind: 'ul', items: [
            ...
            help.filePanel.li_buzzdetect_filter,
            help.filePanel.li_expand,
          ] },
          { kind: 'live', control: 'file-panel-header' },
          { kind: 'h', id: 'columns', text: help.filePanel.h_columns },
          { kind: 'p', text: help.filePanel.p_columns },
          { kind: 'h', id: 'shuffle', text: help.filePanel.h_shuffle },
          { kind: 'p', text: help.filePanel.p_shuffle },
      ...
      },
      {
        ...
        blocks: () => [
          ...
          { kind: 'h', id: 'freq', text: help.spectrogram.h_freqRange },
          { kind: 'p', text: help.spectrogram.p_freq },
