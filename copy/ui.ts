...
export const projectSettingsModal = {
  ...
  get ffmpegPathHint() { return getOverride('ui.projectSettingsModal.ffmpegPathHint') ?? "Used to open .wma files, which have no bundled decoder. Leave blank to use the ffmpeg/ffprobe found on your system PATH."; },
  get ffmpegPathPlaceholder() { return getOverride('ui.projectSettingsModal.ffmpegPathPlaceholder') ?? "Auto-detect from PATH"; },
