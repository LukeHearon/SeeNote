...
export const help = {
  ...
  modes: {
    ...
    get li2() { return getOverride('help.modes.li2') ?? "**Annotation Tool Mode** (a tool is active): left-click & drag directly creates an annotation. Press a number key to switch tools, or `S` or `Enter` to return to Selection Mode."; },
