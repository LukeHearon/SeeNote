...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::audio::set_ffmpeg_path,
            commands::audio::detect_ffmpeg,
            commands::audio::audio_peak,
            commands::audio::get_spectrogram_chunk_range,
            ...
            commands::scan::scan_tree,
            commands::scan::read_scan_cache,
            commands::scan::clear_scan_cache,
            commands::scan::set_scan_priority_folder,
            ...
            commands::archive::guess_project_folder_name,
            ...
            commands::projects::read_app_settings,
