 ...
 *
 *   absent  — never set, so the default applies.
 ...
 */
export function detectionThreshold(value: number | null | undefined): number {
  if (value === undefined) return DEFAULT_BUZZDETECT_THRESHOLD;
