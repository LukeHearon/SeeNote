...
export const help = {
  ...
  launch: {
    ...
    get p_star() { return getOverride('help.launch.p_star') ?? "Hover a project entry to reveal a star. Starred projects are pinned above a divider at the top of the list, sorted by recency among themselves."; },
