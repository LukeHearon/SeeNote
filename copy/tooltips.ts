...
export const tooltips = {
  ...
  get annotationFilterHas() { return getOverride('tooltips.annotationFilterHas') ?? "Showing: tracks with annotations"; },
  get annotationFilterNone() { return getOverride('tooltips.annotationFilterNone') ?? "Showing: tracks without annotations"; },
  get buzzdetectFilterAll() { return getOverride('tooltips.buzzdetectFilterAll') ?? "Buzzdetect results: not filtering"; },
  get buzzdetectFilterHas() { return getOverride('tooltips.buzzdetectFilterHas') ?? "Showing: tracks with buzzdetect results"; },
  get buzzdetectFilterNone() { return getOverride('tooltips.buzzdetectFilterNone') ?? "Showing: tracks without buzzdetect results"; },
};
