...
export const projectBaseFields = {
  ...
  get buzzdetectFrameLengthOverrideHelp() { return getOverride('ui.projectBaseFields.buzzdetectFrameLengthOverrideHelp') ?? "overrides auto-detection for every file"; },
  get buzzdetectFrameLengthOverrideLabel() { return getOverride('ui.projectBaseFields.buzzdetectFrameLengthOverrideLabel') ?? "Override"; },
